...
frame_graficacion.config(bg ="aquamarine", width=380, height=380)
frame_graficacion.place(x=10, y=10)

# creacion de canvas
c = Canvas(frame_graficacion, width=360, height=360, bg="LightSkyBlue2")
c.place(x=10 , y=10)
...
frame_2.config(bg="pale green",width=380,height=90)
